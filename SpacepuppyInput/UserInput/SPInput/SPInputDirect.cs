...
namespace com.spacepuppy.UserInput.SPInput
{
    ...
    public static class SPInputDirect
    {
        ...
        public static bool PollButton(out SPInputButton button, SPJoystick joystick = SPJoystick.All)
        {
        ...
        public static bool PollAxis(out SPInputAxis axis, SPJoystick joystick = SPJoystick.All)
        {
