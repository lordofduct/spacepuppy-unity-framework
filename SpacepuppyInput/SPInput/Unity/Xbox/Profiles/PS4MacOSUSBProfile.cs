...
namespace com.spacepuppy.SPInput.Unity.Xbox.Profiles
{
    ...
    public class PS4MacOSUSBProfile : XboxInputProfile
    {
        ...
        public PS4MacOSUSBProfile()
        {
            ...
            this.RegisterAxis(XboxInputId.LTrigger, SPInputFactory.CreateAxisDelegateFactory_PS4TriggerLike(SPInputId.Axis5));
            this.RegisterAxis(XboxInputId.RTrigger, SPInputFactory.CreateAxisDelegateFactory_PS4TriggerLike(SPInputId.Axis6));
