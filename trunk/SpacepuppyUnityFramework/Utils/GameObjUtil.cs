...
namespace com.spacepuppy.Utils
{
    public static class GameObjectUtil
    {
        ...
        /// <summary>
        /// Tests if the object is either destroyed or despawned.
        /// </summary>
        ...
        public static bool IsKilled(this GameObject obj)
        {
            ...
            var comp = obj.FindComponent<SpawnedObjectController>();
            if (!comp.IsNullOrDestroyed())
            {
                return comp.IsSpawned;
            }
        ...
        public static Rigidbody FindRigidbody(this Component comp)
        {
            if (comp == null) return null;
            return FindRigidbody(comp.gameObject);
        }
